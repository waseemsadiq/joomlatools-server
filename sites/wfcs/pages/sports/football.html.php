...
title: Football
summary: Well Foundation Community Sports Football
metadata:
    robots: [none]
state:
    visible: false
                ...
                <div class="flex flex-wrap">
                    <div class="px-4 max-w-prose mx-auto">
                        <h2 class="wow fadeInUp mb-8 text-2xl font-bold text-dark dark:text-white sm:text-3xl md:text-[35px] md:leading-[1.28]" data-wow-delay=".1s">
                            Well Foundation Community Sports Football
                        </h2>
                        <p class="mb-6 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Come join us at the Well Foundation Community Sports Football! Training sessions take place every Wednesday from 7.30pm to 8.50pm at Ravenscraig, O'Donnal Way, Motherwell, ML1 1AD. Our dedicated coaches are either from Rangers FC, Motherwell FC, or have SFA badges and disclosures. Children aged 4 to 16 are welcome to participate in both training and game time, where they will be grouped according to their age and ability.
                        </p>

                        <div class="flex flex-wrap mb-8 -mx-4">
                            <div class="w-full px-4">
                                <h2 class="wow fadeInUp relative pb-5 text-2xl font-semibold text-dark dark:text-white sm:text-[28px]" data-wow-delay=".1s">
                                    Groups
                                </h2>
                            ...
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3" data-wow-delay=".1s">
                                    <div class="w-full">
                                        <h4 class="inline-block mb-1 text-lg font-medium leading-snug text-dark dark:text-dark-6 lg:text-base xl:text-lg">
                                            White Group
                                        </h4>
                                        <p class="text-sm mb-4 text-body-color dark:text-dark-6">
                                            4-6 year old beginners - Children should be capable of using the toilet independently or have their parents present, as our coaches are not responsible for taking children to the bathroom. The indoor session from 8pm to 9pm is led by Motherwell FC Coaches.
                                        </p>
                                        <p class="text-sm text-body-color dark:text-dark-6">
                                            7.30pm - 8.50pm Outdoors / indoors for drills & games.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3" data-wow-delay=".1s">
                                    <div class="w-full">
                                        ...
                                        <p class="text-sm mb-4 text-body-color dark:text-dark-6">
                                            7-9 Years old - Kids who are just beginning, fundamental exercises for dribbling, passing, shooting, and more.
                                        </p>
                                        <p class="text-sm font-semibold text-body-color dark:text-dark-6">
                                            Run by Motherwell FC Coaches.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-b wow fadeInUp border-stroke dark:border-dark-3" data-wow-delay=".1s">
                                    <div class="w-full">
                                        ...
                                        <p class="text-sm mb-4 text-body-color dark:text-dark-6">
                                            10 - 12 years old - Beginner - Children begin by learning fundamental skills before progressing to more advanced levels.
                                        </p>
                                        <p class="text-sm font-semibold text-body-color dark:text-dark-6">
                                            Run by SFA qualified Coaches.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-0 wow fadeInUp border-stroke dark:border-dark-3 md:border-b lg:border-0" data-wow-delay=".1s">
                                    <div class="w-full">
                                        <h4 class="inline-block mb-1 text-lg font-medium leading-snug text-dark dark:text-dark-6 lg:text-base xl:text-lg">
                                            Sky Blue Group
                                        </h4>
                                        <p class="text-sm text-body-color dark:text-dark-6">
                                            10 - 12 years old - Advanced outdoor drills.
                                        </p>
                                        <p class="text-sm font-semibold text-body-color dark:text-dark-6">
                                            Working with Rangers FC oaches.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-0 wow fadeInUp border-stroke dark:border-dark-3 md:border-b lg:border-0" data-wow-delay=".1s">
                                    <div class="w-full">
                                        ...
                                        <p class="text-sm text-body-color dark:text-dark-6">
                                            3-16 - Outdoors in a five-a-side league format. 
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:w-1/2 lg:w-full">
                                <div class="flex items-center w-full pb-5 mb-5 border-0 wow fadeInUp border-stroke dark:border-dark-3 md:border-b lg:border-0" data-wow-delay=".1s">
                                    <div class="w-full">
                                        <h4 class="inline-block mb-1 text-lg font-medium leading-snug text-dark dark:text-dark-6 lg:text-base xl:text-lg">
                                            Pink Group (Girls Sports)
                                        </h4>
                                        <p class="text-sm mb-4 text-body-color dark:text-dark-6">
                                            Girls participate in a variety of sports on Pitch 2, including Tae Kwon Do, Football, Badminton, Fitness, and more every week, catering to all age groups.
                                        </p>
                                        <p class="text-sm font-semibold text-body-color dark:text-dark-6">
                                            Supported by North Lanarkshire &amp; Rangers &amp; Motherwell Female coaches
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[5px] bg-primary/5 px-6 py-8 text-center sm:p-10 md:px-[60px]" data-wow-delay=".1s">
                            <div class="mx-auto max-w-[530px]">
                                ...
                                <? foreach (data('testimonials')->shuffle()->slice(0, 1) as $item) : ?>
                        ...
                        <h3 class="wow fadeInUp mb-6 text-2xl font-semibold text-dark dark:text-white sm:text-[28px] sm:leading-[40px]" data-wow-delay=".1s">
                            Next steps
                        </h3>
                        <p class="mb-6 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Feel free to join our Community WhatsApp group to stay updated on all things Football - <a class="text-dark hover:text-primary dark:text-white" href="https://chat.whatsapp.com/Jtz4Enz2yOQLOBqoRgTE77">https://chat.whatsapp.com/Jtz4Enz2yOQLOBqoRgTE77</a>
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Each child costs £18 for a 4-week block, or you can opt for weekly online payments of £5.50 per child at <a class="text-dark hover:text-primary dark:text-white" href="https://well-foundation-sports.classforkids.io">https://well-foundation-sports.classforkids.io</a>
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Please ensure that your child(ren) come prepared with water and suitable clothing as the sessions will be held both indoors and outdoors.
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Well Foundation Children Protection number: <span class="font-semibold">1329</span><br>
                            Child Protection Officer: <span class="font-semibold">Fahim Baqir 07714 247787</span>
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            All of our coaches possess Disclosures to work with children and SFA badges to instruct the little ones. 
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Ravenscraig facilities are equipped with CCTV cameras to ensure the safety of both children and coaches.
                        </p>
                        <p class="mb-10 text-base wow fadeInUp text-body-color dark:text-dark-6" data-wow-delay=".1s">
                            Please ensure that children are brought to and collected from the pitch. It is the parents' duty to ensure that kids are brought and picked up punctually.
                        </p>
                    </div>
                </div>
            </div>
